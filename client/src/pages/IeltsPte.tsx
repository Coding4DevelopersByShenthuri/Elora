...
const IeltsPtePage = () => {
  ...
  return (
    <div className="min-h-screen pb-12 md:pb-16 lg:pb-20 pt-24 sm:pt-28 md:pt-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-4 md:mb-6 leading-relaxed px-4">
        ...
        <div className="flex justify-center mb-8 md:mb-12">
          <Tabs defaultValue="ielts" className="w-full max-w-4xl">
            <TabsList className="grid w-full grid-cols-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-1 sm:p-2 rounded-xl sm:rounded-2xl shadow-sm">
              {testTypes.map((test) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
            ...
            <CardContent className="p-5 md:p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8">
                <div className="mb-3 sm:mb-0">
                  ...
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Track your preparation journey and target achievement</p>
                </div>
                <div className="text-right">
                  <div className="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400">{mockTestProgress}%</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Preparation Complete</div>
                </div>
              </div>
              
              <Progress value={mockTestProgress} className="h-3 bg-gray-100 dark:bg-gray-700 mb-6 md:mb-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 md:p-6 rounded-xl border border-blue-200 dark:border-blue-800">
                <div className="flex items-center justify-between mb-3 md:mb-4">
                  <div className="text-center flex-1">
                    <div className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{currentScore.toFixed(1)}</div>
                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Current Score</div>
                  </div>
                  <div className="text-center flex-1">
                    <div className="text-base sm:text-lg text-gray-500 dark:text-gray-400">→</div>
                  ...
                  <div className="text-center flex-1">
                    ...
                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Target Score</div>
                  </div>
                </div>
          ...
          <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
            <CardContent className="p-5 md:p-6 lg:p-8">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4 md:mb-6">Performance Overview</h3>
