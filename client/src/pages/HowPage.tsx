      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          <div ref={heroRef} className="relative w-full max-w-3xl mx-auto">
            ...
            <div className="glass-panel rounded-full py-5 px-8 inline-block mx-auto mb-12">
              <h1 className="text-2xl md:text-3xl font-bold text-primary">How does Vocario work?</h1>
            </div>
        ...
        <div className="mb-24">
          ...
          <FeatureShowcase
            ...
            description="Vocario offers category-based modules for Kids, Adults, and IELTS/PTE learners, tailored to your skill level and learning goals."
            image="./image6.png"
            features={[
          ...
          <FeatureShowcase
            ...
            description="Quickly find the lessons, exercises, and practice sessions you need. Vocario helps you navigate your learning path efficiently and stay on track."
            image="./image7.png"
            features={[
          ...
          <FeatureShowcase
            ...
            description="Vocario's AI helps you discover patterns in your learning, providing personalized guidance and suggestions to improve your English skills efficiently."
            image="./image8.png"
            features={[
          ...
          <FeatureShowcase
            ...
            description="Vocario keeps your learning progress and data completely private. All exercises, lessons, and feedback are stored locally, giving you full control and offline access."
            image="./image9.png"
            features={[
          ...
          <FeatureShowcase
            ...
            description="Vocario acts as an extension of your learning journey, guiding you through interactive lessons, practice exercises, and real-time feedback across all your devices."
            image="./image10.png"
            features={[
        ...
        <div className="py-16 px-4 rounded-lg glass-panel my-24">
          ...
          <p className="text-xl text-center text-foreground/80 max-w-3xl mx-auto mb-16">
            Focus on improving your English skills while Vocario handles the rest — practice, feedback, and progress tracking.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ValueProp
              ...
              title="Learn with AI"
              description="Vocario uses offline AI to provide real-time conversation practice, pronunciation scoring, and personalized feedback."
            />
            <ValueProp
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-foreground/80 mb-4">
                Vocario leverages cutting-edge AI and offline speech models to provide pronunciation feedback, interactive conversations, and personalized learning paths.
              </p>
