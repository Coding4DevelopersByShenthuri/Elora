  ...
  return (
    <div className={`min-h-screen relative overflow-hidden bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950 ${isLoaded ? 'space-fade-in' : 'opacity-0'}`}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-gradient-radial from-indigo-500/25 via-amber-500/15 to-transparent rounded-full blur-3xl nebula-effect animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-0 left-1/3 w-[700px] h-[700px] bg-gradient-radial from-purple-500/20 via-amber-500/10 to-transparent rounded-full blur-3xl nebula-effect animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
