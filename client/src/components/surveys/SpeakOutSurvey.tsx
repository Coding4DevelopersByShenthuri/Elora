...
const SpeakOutSurvey: React.FC<SpeakOutSurveyProps> = ({
  ...
  React.useEffect(() => {
    if (isOpen) {
      console.log('✅ SpeakOutSurvey (Step 5) is now OPEN');
    } else {
      console.log('❌ SpeakOutSurvey (Step 5) is now CLOSED');
    }
  }, [isOpen]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent 
        ...
        title="Speak Out Survey"
        description="Answer the speak out question"
      >
