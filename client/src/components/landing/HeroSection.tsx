...
export const HeroSection = ({
  ...
  const [heroText, setHeroText] = useState("All your English lessons, exercises, conversations, and practice tools in one personal, offline AI tutor, accessible anytime, anywhere.");
  ...
  return <div className="py-20 md:py-28 flex flex-col items-center text-center">
    <AnimatedTransition show={showTitle} animation="slide-up" duration={600}>
      {/* Title first */}
      <h1 className="text-4xl sm:text-5xl font-bold mb-6 bg-clip-text text-teal-500 md:text-7xl">
